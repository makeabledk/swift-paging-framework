...
class PagingMediator<FuncParameters, ReturnType: Collection> {
    ...
    init(pageLimit: Int, pagedFunc: @escaping (_ params: FuncParameters, _ page: Int, _ limit: Int, _ completion: @escaping (_ result: ReturnType?, _ totalCount: Int?, _ error: PagingMediatorError?) -> Void) -> ()) {
     ...
     */
    func getResults(params: FuncParameters, completion: @escaping (_ result: ReturnType?, _ error: PagingMediatorError?) -> Void) {
    ...
    fileprivate var moreResults: Bool {
        get {
     ...
     */
    func tableViewShouldLoadMoreData(loadOffset: Int? = nil, indexPath: IndexPath, tableView: UITableView) -> Bool {
